...
{
	/// <summary>
	/// This should be a reference to the OVRCameraRig that is usually a child of the MyPlayerController.
	/// </summary>
	[Tooltip("This should be a reference to the OVRCameraRig that is usually a child of the MyPlayerController.")]
	...
	/// <summary>
	/// This method is the handler for the MyPlayerController.CameraUpdated event, which is used
	...
	/// <summary>
	/// This method is the handler for the MyPlayerController.PreCharacterMove event, which is used
